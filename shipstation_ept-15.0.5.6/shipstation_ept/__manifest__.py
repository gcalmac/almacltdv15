{
    ...
    'depends': ['common_connector_library', 'delivery', 'stock_picking_batch'],
    'data': [
        ...
        'view/form_view_product_packaging.xml',
    ...
    'images': ['static/description/ShipStation.png'],
    # Author
    ...
    'auto_install': False,
    'application': True,
    'live_test_url': 'https://www.emiprotechnologies.com/free-trial?app=shipstation-ept&version=15&edition=enterprise',
    'price': '79',
    'currency': 'EUR',
}
