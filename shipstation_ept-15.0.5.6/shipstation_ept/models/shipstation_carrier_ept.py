...
class ShipstationCarrier(models.Model):
    ...
    shipstation_instance_id = fields.Many2one('shipstation.instance.ept',
                                              string='Instance',
                                              ondelete='cascade')
    shipstation_package_ids = fields.One2many('product.packaging', 'shipstation_carrier_id',
        ...
        for rec in self.shipstation_service_ids:
            ...
            if not carrier:
                ...
                vals = {"name": rec.service_name,
                        ...
                        'shipstation_user_id': instance.shipstation_user_id.id,
                        'shipstation_auto_create_batch': instance.shipstation_auto_create_batch,
                        'shipstation_batch_limit': instance.shipstation_batch_limit,
                        'shipstation_auto_done_pickings': instance.shipstation_auto_done_pickings,
                        'shipstation_use_existing_batch_cronjob': instance.shipstation_use_existing_batch_cronjob,
            ...
            _logger.info(
                "Instance: {}, Shipstation Carrier: {}, Shipstation Service: {}, Carrier: {}".format(instance.name,
                                                                                                     ...
                                                                                                     rec.service_name,
                                                                                                     carrier.name))
        # Added by [ES] | Task: 182460 | Dated on 11 Jan 2022
        if shipping_methods:
            return {
