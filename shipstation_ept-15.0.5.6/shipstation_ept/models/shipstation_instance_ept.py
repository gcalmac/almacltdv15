...
class ShipstationInstanceEpt(models.Model):
    ...
    # Added by [ES] | Task: 182454 | Dated on 10, Jan 2020
    ...
    # Added by [ES] | Task: 182458 | Dated on Jan 17, 2022
    ...
    # Added by [ES] | Task: 182456 | Dated 12 Jan, 2022
    ...
    def test_shipstation_connection(self):
        ...
        # Modified by E.Selvi | Task: 182459 | Dated 10, Jan 2022
        return {
    ...
    def view_shipstation_packages(self):
        """
        Modified By: Hardik Joshi
        Modification: change form_view_id = self.env.ref('shipstation_ept.form_view_product_packaging', False).id
        instead of self.env.ref('product.product_packaging_form_view', False).id
        New form view created for product_packaging model
        Task No.: 192689 - Product field should not visible
        Date: 13-06-2022
        """
        tree_view_id = self.env.ref('stock.product_packaging_tree_view', False).id
        form_view_id = self.env.ref('shipstation_ept.form_view_product_packaging', False).id
        return {
    ...
    def get_shipstation_packages(self):
        ...
        """
        product_package_obj = self.env['product.packaging']
    ...
    def export_to_shipstation_cron(self, ctx={}, store_ids=False, start_date=False, end_date=False):
        ...
        for picking in pickings:
            ...
            try:
                ...
                picking.export_order_to_shipstation(log_book)
                ...
                log_book.create_log_book_line_for_shipstation(msg, model_id, picking)
    ...
    def is_shipstation_instance_exist(self):
        # Modified by [ES] | Task: 182453 | Dated on 10, Jan 2022
